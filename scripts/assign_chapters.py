...
_ntrs = [
    ...
    (15, '跨线', 'C', ['N44','N45','N46','N47','N48','N49','N50','N51','N52','N53','N54','N55','N56','N57','N58'],
     '★被干软提问→白丝勾引雷恩→第二次低语者→温柔疗愈选凯尔→第一次被插入(凯尔)→翌日疗愈→走廊绯红→犹豫选雷恩→桌下吞精→弯腰弧度→夜谈乔治→试衣镜前→雷恩第二次→隐奸设计'),
    (16, '放开', 'D前半', ['N59','N60','N61','N62','N63','N64','N65','N66'],
     '圈子开放→劳拉乳交→姐妹足交→亚莉莎→四人共享→劳拉白袜→艾玛手交实证→艾玛传送门→菲的早晨'),
    (17, '享受', 'D后半', ['N67','N68','N69','N70','N71','N72','N73','N74','N75','N76','N77'],
     '醉诱→温泉羞辱→密林即兴→菲本番→镜湖→胜利3P→温泉晕厥→艾玛吊带袜→亚莉莎本番→花田3P→玲本番'),
    (18, '极限', 'E前半', ['N78','N79','N80','N81','N82','N83','N84','N85','N86','N87'],
     '主动手交→艾德里安舌→雷恩裸足→劳拉骑士→雷恩跪礼→凯尔独白→第一次自己决定→凯尔观摩→主动口交→桌下之手'),
    (19, '反转', 'E后半', ['N88','N89','N90','N91','N92','N93','N94','N95','N96','N97'],
     '桌下之口→凯尔邀请→乔治震动棒→腐化迷雾→黑暗乳交→催情茶→低语者轮奸→洗干净回归'),
    (20, '终局', '终局', ['N98','N99','N100'],
     '她的情书→终局抉择'),
]

...
_ntrs = [
    ...
    (15, '跨线', 'C', ['N44','N45','N46','N47','N48','N49'],
     '★被干软提问→白丝勾引雷恩→第二次低语者→温柔疗愈选凯尔→第一次被插入(黎恩握手)→雷恩第二次'),
    (16, '放开', 'D前半', ['N50','N51','N52','N53','N54','N55','N56','N57','N58','N59'],
     '隐奸→圈子开放→劳拉乳交→姐妹足交→亚莉莎→四人共享→劳拉白袜→艾玛传送门→菲的早晨→醉诱'),
    (17, '享受', 'D后半', ['N60','N61','N62','N63','N64','N65','N66','N67','N68','N69','N70'],
     '温泉羞辱→密林即兴→菲本番→镜湖→胜利3P→温泉晕厥→艾玛吊带袜→亚莉莎本番→花田3P→玲本番'),
    (18, '极限', 'E前半', ['N71','N72','N73','N74','N75','N76','N77','N78','N79','N80'],
     '主动手交→艾德里安舌→雷恩裸足→劳拉骑士→雷恩跪礼→凯尔独白→第一次自己决定→凯尔观摩→主动口交→桌下之手'),
    (19, '反转', 'E后半', ['N81','N82','N83','N84','N85','N86','N87','N88','N89','N90'],
     '桌下之口→凯尔邀请→乔治震动棒→腐化迷雾→黑暗乳交→催情茶→低语者轮奸→洗干净回归'),
    (20, '终局', '终局', ['N91','N92','N93'],
     '她的情书→终局抉择'),
]

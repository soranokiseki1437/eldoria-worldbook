...
_ntrs = [
    ...
    (16, '放开', 'D前半', ['N62','N63','N64','N65','N66','N67','N68','N69','N70','N71'],
     '圈子开放→劳拉乳交→姐妹足交→艾德里安本番→亚莉莎→四人共享→劳拉白袜→艾玛传送门→草药咖啡拘束→菲的早晨'),
    (17, '享受', 'D后半', ['N72','N73','N74','N75','N76','N77','N78','N79','N80','N81'],
     '醉诱→温泉羞辱→密林即兴→菲本番→镜湖→胜利3P→温泉晕厥→艾玛吊带袜→亚莉莎本番→花田3P'),
    (18, '极限', 'E前半', ['N82','N83','N84','N85','N86','N87','N88','N89','N90','N91','N92'],
     '亚尔缇娜足交→欲望之镜→玲游戏本番→主动手交→艾德里安舌→雷恩裸足→劳拉骑士→雷恩跪礼→第一次自己决定→凯尔独白→凯尔观摩'),
    (19, '反转', 'E后半', ['N93','N94','N95','N96','N97','N98','N99','N100','N101','N102'],

...
_ntrs = [
    ...
    (17, '享受', 'D后半', ['N73','N74','N75','N76','N77','N78','N79','N80','N81','N82'],
     '醉诱→温泉羞辱→密林即兴→菲本番→镜湖→胜利3P→温泉晕厥→艾玛吊带袜→亚莉莎本番→花田3P'),
    (18, '极限', 'E前半', ['N83','N84','N85','N86','N87','N88','N89','N90','N91','N92','N93'],
     '亚尔缇娜足交→欲望之镜→玲游戏本番→主动手交→艾德里安舌→雷恩裸足→劳拉骑士→雷恩跪礼→第一次自己决定→凯尔独白→凯尔观摩'),
    (19, '反转', 'E后半', ['N94','N95','N96','N97','N98','N99','N100','N101','N102','N103'],
